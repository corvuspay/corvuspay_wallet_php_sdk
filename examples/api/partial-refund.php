...
<head>
    ...
    <title>Example for partially refund a transaction</title>
...
// Check if the uploaded file has (*.p12) extension.
    ...
    if ($fileExtension === $fileExtensionAllowed) {
        ...
        try {
            ...
            if ((string)$response->{'account-id'}[0] !== "") {
                $params["account_id"]             = (string)$response->{'account-id'}[0];
                $_SESSION["params"]["account_id"] = (string)$response->{'account-id'}[0];
            }
...
Successfully refunded the amount!
...
<div class="card">
    <div class="p-4">
        Example for partially refund a transaction
    </div>
    <div class="card-body">
        <form role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label for="new_amount_id" class="col-sm-2 col-form-label">Amount to refund (string):</label>
        ...
        <div class="row">
            <div class="col-12 m-4">
                ...
                <div class="btn-group">
                    <?php if ($status === "refunded" && isset($params) && isset($params["account_id"])) { ?>
