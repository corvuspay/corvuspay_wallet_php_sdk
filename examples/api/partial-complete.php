...
<head>
    ...
    <title>Example for partially completing a transaction</title>
...
// Check if the uploaded file has (*.p12) extension.
    ...
    if ($fileExtension === $fileExtensionAllowed) {
        ...
        try {
            ...
            $res_xml  = $client->transaction->partiallyComplete($params, true);
            $response = [];
...
Successfully partially completed the transaction!
...
<div class="card">
    <div class="p-4">
        Example for partially completing a transaction
    </div>
    <div class="card-body">
        <form role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <input id="new_amount_id" name="new_amount" class="text_input col-sm-2"
                       ...
                       else echo NEW_AMOUNT_FOR_PARTIAL_COMPLETE; ?>" required>
            </div>
