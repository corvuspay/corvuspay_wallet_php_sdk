...
<head>
    ...
    <title>Example for refunding a transaction</title>
...
// Check if the uploaded file has (*.p12) extension.
    ...
    if ($fileExtension === $fileExtensionAllowed) {
        ...
        try {
            ...
            $res_xml = $client->transaction->refund($params, true);
                ...
                <div class="btn-group">
                    <?php if ($status === "refunded" && isset($params) && isset($params["account_id"])) { ?>
                        ...
                        <input type="hidden" name="order_number"
                               value="<?php if (isset($config) && isset($config['order_number'])) echo $params['order_number'] ?>">
